# Catan Pokémon — tú contra 3 CPUs

## Arranque rápido (doble click)
- **Windows:** `Catan.bat`
- **macOS/Linux:** `Catan.command`
- Alternativa terminal: `./jugar-catan.sh`

## Novedades
- Puedes elegir tu color/equipo al iniciar:
  - 🔥 Charmander (rojo)
  - 💧 Squirtle (azul)
  - 🌿 Bulbasaur (verde)
  - ⚡ Pikachu (amarillo)
...
## Cerrar
En la terminal del lanzador: `Ctrl + C`.
